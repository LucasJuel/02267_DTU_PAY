...
Feature: Outer Blackbox Payment
  Scenario: Customer pays merchant using public DTU Pay API
    ...
    And a customer with firstName "Blackbox" lastName "Customer" CPR "115928-1111" is created in the bank with balance 1000 kr
    And a merchant with firstName "Blackbox" lastName "Merchant" CPR "222204-2222" is created in the bank with balance 500 kr
